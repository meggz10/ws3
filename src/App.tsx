...
> {
  ...
  connect() {
    this.socket = io.connect("https://socket03.onrender.com"); //nuestro server local
  ...
  setearIndicadormic = ()  => {
    ...
    xhttp.open("GET", 'https://eventos03.onrender.com/mic', true);
    xhttp.send();
  }
...
setearIndicadormic_off = ()  => {
    ...
    xhttp.open("GET", 'https://eventos03.onrender.com/mic_apagar', true);
    xhttp.send();
  }
  ...
  setearIndicador1 = ()  => {
    ...
    xhttp.open("GET", 'https://eventos03.onrender.com/face1', true);
    xhttp.send();
  }
  ...
  setearIndicador2 = ()  => {
    ...
    xhttp.open("GET", 'https://eventos03.onrender.com/face2', true);
    xhttp.send();
  }
  ...
  setearIndicador3 = ()  => {
    ...
    xhttp.open("GET", 'https://eventos03.onrender.com/face3', true);
    xhttp.send();
  }
  ...
  MicButton_Remoto = () => {
    ...
    xhttp.open("GET", 'https://eventos03.onrender.com/mic_remoto0', true);
    xhttp.send();
    }
    else
    {
    ...
    xhttp.open("GET", 'https://eventos03.onrender.com/mic_remoto1', true);
    xhttp.send();
  ...
  setearIndicador4 = ()  => {
    ...
    xhttp.open("GET", 'https://eventos03.onrender.com/face4', true);
    xhttp.send();
  }
 ...
 setearIndicador5 = ()  => {
    ...
    xhttp.open("GET", 'https://eventos03.onrender.com/face5', true);
    xhttp.send();
  }
  ...
  setearIndicador6 = ()  => {
    ...
    xhttp.open("GET", 'https://eventos03.onrender.com/face6', true);
    xhttp.send();
  }
  ...
  setearIndicador7 = ()  => {
    ...
    xhttp.open("GET", 'https://eventos03.onrender.com/face7', true);
    xhttp.send();
  }
  ...
  setearIndicador8 = ()  => {
    ...
    xhttp.open("GET", 'https://eventos03.onrender.com/face8', true);
    xhttp.send();
  }
